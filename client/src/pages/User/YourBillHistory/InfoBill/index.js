          ...
          <div className={cx('info-order')}>
            ...
            <div className={cx('container_hanghoa')}>
              <span className={cx('title_container')}>Danh mục hàng hóa</span>
              {
                [1, 2, 3, 4].map(() => {
                  return (
                    <div className={cx('item_hanghoa')}>
                      <span className={cx('name_hanghoa')}>Thuốc cảm cúm của bộ y tế</span>
                      <div className={cx('container_field')}>
                        <span className={cx('title')}>Lĩnh vực: </span>
                        <span className={cx('content')}>Y tế</span>
                      </div>
                      <div className={cx('container_field')}>
                        <span className={cx('title')}>Tổng khối lượng: </span>
                        <span className={cx('content')}>102.45 kg</span>
                      </div>
                    </div>
                  )
                })
