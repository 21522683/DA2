...
import { setIsOpenMessageBox, setLoading } from '../../../../redux/slices/vesselSlice';
...
function MessageBox() {
  ...
  const itemSelected = listVessels[indexSelected];

  const handleSend = async () => {
    try {
      const url = `${baseUrl}/vessel/deleteVessel/${itemSelected._id}`;
